...
export default function Head() {
  return (
    <div className="flex fixed top-0 left-0 w-full h-[var(--header-height)] bg-secondary-100 drop-shadow">
        <Sidebar />
      <div className="container px-4 h-[var(--header-height)] mx-auto flex flex-wrap items-center justify-end xl:justify-between">
        <div className="lg:w-auto lg:static lg:block lg:justify-start">
          <Link className="inline-block" href="/">
            <Image src={Logo} className="mt-[2px] max-w-[90px] max-h-[60px] object-cover" alt="brand-logo" />
          </Link>
        </div>
        <Navbar />
      </div>
